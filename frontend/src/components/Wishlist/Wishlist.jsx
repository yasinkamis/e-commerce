...
const Wishlist = ({ setOpenWishlist }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10">
      <div className="fixed top-0 right-0 h-full w-[80%] overflow-y-scroll 800px:w-[25%] bg-[#FCC8D1] flex flex-col justify-between shadow-sm">
    ...
    <div className="border-b p-4">
      <div className="w-full 800px:flex items-center">
        ...
        <div className="pl-[5px] text-[#D14D72]">
          <h1>{data.name}</h1>
          <h4 className="font-[600] pt-3 800px:pt-[3px] text-[17px] text-[#D14D72] font-Roboto">
            US${totalPrice}
          </h4>
        </div>
        <div>
