...
const CreateProduct = () => {
  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Ürün Oluştur</h5>
      {/* create product form */}
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          >
            <option value="Choose a category">Kategori Seç</option>
            {categoriesData &&
        ...
        <br />
        <div>
          <label className="pb-2">Etiketler</label>
          <input
            type="text"
            name="tags"
            value={tags}
        ...
        <br />
        <div>
          <label className="pb-2">Orijinal Fiyat</label>
          <input
            type="number"
            name="price"
            value={originalPrice}
        ...
        <div>
          <label className="pb-2">
            Fiyat (İndirim Dahil) <span className="text-red-500">*</span>
          </label>
          <input
            type="number"
            name="price"
        ...
        <div>
          ...
          <div>
            <input
              type="submit"
              value="Oluştur"
              className="mt-2 cursor-pointer appearance-none text-center block w-full px-3 h-[35px] border border-[#D14D72] rounded-[3px] placeholder-[#D14D72] focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </div>
        </div>
      </form>
