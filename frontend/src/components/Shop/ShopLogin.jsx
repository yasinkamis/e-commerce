    ...
    <div className="min-h-screen bg-[#D14D72] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-white">
          Kiralatan Hesabınıza Giriş Yapın
        </h2>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-[#D14D72] rounded-md shadow-sm placeholder-[#D14D72] focus:outline-none focus:ring-[#D14D72] focus:border-[#D14D72] sm:text-sm"
                />
              </div>
            </div>
            <div>
            ...
            <div className={`${styles.noramlFlex} justify-between`}>
              <div className={`${styles.noramlFlex}`}>
                <input
                  ...
                  name="remember-me"
                  id="remember-me"
                  className="h-4 w-4 text-[#D14D72] focus:ring-[#D14D72] border-[#D14D72] rounded"
                />
                <label
                  htmlFor="remember-me"
            ...
            <div className={`${styles.noramlFlex} w-full`}>
              ...
              <Link to="/shop-create" className="text-[#D14D72] pl-2">
                Kayıt Ol
              </Link>
            </div>
          </form>
