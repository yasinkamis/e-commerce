  ...
  export const brandingData = [
    {
      ...
      Description: "Ücretsiz kargo ile kapınıza kadar teslimat",
      icon: (
        <svg
          width="36"
          height="36"
    ...
    },
    {
      ...
      Description: "%25'e Varan İndirimler",
      icon: (
        <svg
          width="32"
          height="34"
    ...
    {
      id: 4,
      title: "Cazip Fiyatlar",
      Description: "Her Bütçeye Uygun Fiyatlar",
      icon: (
        <svg
          width="32"
          height="35"
